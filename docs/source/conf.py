...
# stock_price_classification documentation build
...
from stock_price_classification import __version__ as release

# -- Project information -----------------------------------------------------

project = "stock_price_classification"
author = "Kedro"
...
htmlhelp_basename = "stock_price_classificationdoc"
...
latex_documents = [
    (
        master_doc,
        "stock_price_classification.tex",
        "stock_price_classification Documentation",
        "Kedro",
        "manual",
    )
]
